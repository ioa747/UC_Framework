...
![GUI with UC_Framework](UC_Framework/UC/Assets/260618-111133-129_AutoIt3_1gErC.gif)
...
The only **modification** that needs to be made to **UC_Framework** is to "**\UC_Framework\UC\Frame\UC_Frame.au3**"  
